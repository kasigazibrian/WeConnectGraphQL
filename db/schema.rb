...
ActiveRecord::Schema.define(version: 2018_12_10_101900) do
  ...
  create_table "businesses", force: :cascade do |t|
    ...
    t.index ["contact_number", "name", "email"], name: "index_businesses_on_contact_number_and_name_and_email", unique: true
